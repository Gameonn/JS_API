	...
	<div id="mainmenu">
		...
		$this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Jobs', 'url'=>array('/rights/job/admin'), 'visible'=>!Yii::app()->user->isGuest),
				array('label'=>'Questionaire', 'url'=>array('/rights/question/admin'), 'visible'=>!Yii::app()->user->isGuest),
