  ...
  <section id="product">
    <div class="container" id="cartTable">
     <!--  breadcrumb --> 
        ...
        <!-- Account Login-->
        <div class="span12">
          <h1 class="heading1"><span class="maintext">&nbsp;</span><span class="subtext"> Address Details</span></h1>
                  ...
                  <div class="span12">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        ...
                        <div class="row" style="float:right;">Shipping Details
    ...
    <?php echo Yii::app()->user->getFlash('showMsg'); ?>
         ...
         if(count($listReward)>0){  
          // get the product ids
            ...
            <td class="total">$<?php echo  $total_price_final; ?></td>
