...
class UserIdentity extends CUserIdentity
{
    ...
    {
        //echo $_REQUEST['AdminUserForm']['userType'];
        //die;
        if($_REQUEST['AdminUserForm']['userType']=='Front') // This is front login
        {
         ...
         if($_REQUEST['AdminUserForm']['userType']=='Back')// This is admin login
        {
