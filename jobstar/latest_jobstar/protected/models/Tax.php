...
class Tax extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			//array('title, price,description', 'length', 'max'=>50),
	...
	*/
	...
	public function searchTax()
	{
    	...
    	$sql  = "SELECT percent from shop_tax where title = 'tax'";	
		...
		public function searchVat()
	{

    	$sql  = "SELECT percent from shop_tax where title = 'vat'";	
      	$list = Yii::app()->db->createCommand($sql)->queryRow();
	 	return $list['percent'];
